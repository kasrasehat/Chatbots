...
class Agent:
    def __init__(self, model, tools, checkpointer, system="", user_input='', router_prompt="", job_post_prompt=""):
        self.system = system
        ...
        graph.add_conditional_edges(START, self.router, {'recruiter': "llm", 'job_post_maker': "job_poster", 'meeting_scheduler': END, 'general_questions':END})
...
def get_response(user_input, state):
    ...
    with SqliteSaver.from_conn_string(":memory:") as memory:
        abot = Agent(model, tools, checkpointer=memory, system=prompt, user_input=user_input, router_prompt= router_system_prompt, job_post_prompt=job_post_prompt)
