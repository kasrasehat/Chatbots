...
model = AzureChatOpenAI(
    openai_api_key=os.getenv('AZURE_ACCESS_TOKEN'),
...
# Connect to Redis - Only pass password if it exists
if REDIS_PASSWORD:
...
def get_response(employer_ID, user_input, state):
    ...
    job_post_prompt = f"employer id is {employer_ID if employer_ID else 'None'}. /n/n"+ os.getenv('job_post_system_prompt')
